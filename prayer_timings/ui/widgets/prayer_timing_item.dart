...
class PrayerTimingItem extends StatelessWidget {
  const PrayerTimingItem({super.key, required this.index});
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<PrayerCubit, PrayerState>(
      ...
      builder: (context, state) {
        ...
        switch (index) {
          case 0:
            prayerTime = prayerTimes.fajrStartTime.toString();
            break;
          case 1:
            prayerTime = prayerTimes.sunrise.toString();
            break;
          case 2:
            prayerTime = prayerTimes.dhuhrStartTime.toString();
            break;
          case 3:
            prayerTime = prayerTimes.asrStartTime.toString();
            break;
          case 4:
            prayerTime = prayerTimes.maghribStartTime.toString();
            break;
          case 5:
            prayerTime = prayerTimes.ishaStartTime.toString();
            break;
          default:
            prayerTime = '';
        }
        ...
        final formattedTime = DateFormat(
          'hh:mm a',
        ).format(DateTime.parse(prayerTime).toLocal());
